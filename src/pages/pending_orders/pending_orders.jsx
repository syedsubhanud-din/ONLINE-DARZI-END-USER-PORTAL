...
function Pending_orders() {
    ...
    useEffect(() => {
        ceate_pending_orders_card();
    }, [])



    const ceate_pending_orders_card = () => {


        for (let i = 0; i < 0; i++) {

            const show_all_pending_orders = document.getElementById('show_all_pending_orders')
            ...
            main_user_details_div.classList.add('pending')
            ...
            show_all_pending_orders.appendChild(inner_home_section_inner_div1_all_order_show)
            ...
            <section className="home-section">
                ...
                <div className="main_home_section">
                    <div className="inner_home_section">
                        ...
                        <div className="inner_home_section_inner_div1" id="show_all_pending_orders">
